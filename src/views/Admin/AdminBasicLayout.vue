<template>
  <a-layout class="layout-demo">
    ...
    <a-layout-header class="bg-white d-flex flex-row fixed-top" style=" height: 64px">
    ...
    <a-layout-content class="" style="padding-top: 64px">
      <a-tabs :active-key="defaultSelectedKey[0] || ['dashboard']" :editable="true" :lazy-load="true"
              :show-add-button="false" animation
              class="" justify position="top"
              size="large"
        ...
        <a-tab-pane v-for="item of data" :key="item.key" :closable="item.closable" :title="item.title"
          ...
          <div class="p-4" style="min-height: fit-content; height: max-content">
    ...
    <!--    <a-layout class="d-flex flex-row">-->
    <!--      <a-layout-sider class="position-fixed flex-grow-0" style="z-index: 98;height: 100vh"-->
    <!--                      breakpoint="lg"-->
    <!--                      collapsible-->
    <!--                      :collapsed="collapsed"-->
    <!--                      @collapse="onCollapse"-->
    <!--      >-->
    <!--        <div class="logo bg-secondary my-3 mx-auto p-3" style="width: 5px" />-->
    <!--        -->
    <!--      </a-layout-sider>-->

    <!--      <a-layout class="flex-grow-1" :style="{'margin-left':`${marginBar}`}" style="padding: 24px 24px; min-height: fit-content; margin-top: 64px;">-->

    <!--       -->
    <!--&lt;!&ndash;        <a-layout-footer>Footer</a-layout-footer>&ndash;&gt;-->
    <!--      </a-layout>-->
    <!--    </a-layout>-->
  </a-layout>
</template>
...
import AdminNotificationView from '/src/views/Admin/AdminNotificationView.vue';
import AdminDashBoard from "./AdminDashBoard.vue";
import StatisticComp from "../../components/StatisticComp.vue";

export default {
  name: "AdminBasicLayout",
  components: {
    IconHome, IconCalendar, AdminNotificationView
  },
  data() {
    return {}
  },
...
.arco-tabs-tab {
  box-shadow: 0 0 0 1px rgba(244, 244, 244, 1);
